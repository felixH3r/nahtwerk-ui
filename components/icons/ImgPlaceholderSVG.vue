<template>
  <svg width="175" height="175" viewBox="0 0 24 24" fill="none" stroke="grey"
    ...
    <path
        ...
        stroke="lightgrey" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path>
    <path
        d="M9.5 11C10.3284 11 11 10.3284 11 9.5C11 8.67157 10.3284 8 9.5 8C8.67157 8 8 8.67157 8 9.5C8 10.3284 8.67157 11 9.5 11Z"
        stroke="lightgrey" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path>
    <path d="M20 15.0909L15.625 11L6 20" stroke="lightgrey" stroke-width="1" stroke-linecap="round"
