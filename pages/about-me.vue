<template>
  ...
  <section class="py-20 ">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <h2 class="font-manrope text-4xl text-center text-gray-900 font-bold mb-14">Was mich ausmacht!</h2>
  ...
  <section class="py-14 lg:py-24 bg-primary-100">
    <h2 class="font-manrope text-4xl text-center font-bold text-gray-900 mb-6">Bei Fragen melde dich gerne bei mir
      persönlich.
    </h2>
      ...
      <div
        ...
        <div class="text-center lg:text-left lg:max-w-xs flex-1">
          <div class="mb-5 pb-5 border-b border-solid border-gray-300">
            <h6 class="text-lg text-gray-900 font-semibold mb-1">Magdalena Schwarz</h6>
            <span class="text-sm text-gray-500">Am besten erreicht man mich per oder per Instagram.</span>
          </div>
          <p class="text-gray-500 leading-6 mb-7">
            E-Mail: office@nahtwerk.at
          </p>
          <div class="flex items-center gap-4 justify-center lg:justify-start">
            <NuxtLink to="mailto:office@nahtwerk.at"
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke="black" stroke-width="1.5px" class="my-path"></path>
                <path
                    ...
                    stroke="black" stroke-width="1.5px" stroke-linecap="round" stroke-linejoin="round"
                    class="my-path"></path>
              </svg>
            </NuxtLink>
            <NuxtLink to="https://www.instagram.com/nahtwerk_/" target="_blank"
                      class="cursor-pointer  text-gray-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-primary-700">
