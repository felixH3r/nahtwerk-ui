<template>
  <section id="impressum" class="p-4">
    <h1 class="text-2xl font-semibold">Impressum</h1>

    <p class="mt-5"><strong>Angaben gemäß § 5 TMG:</strong></p>

    <p class="mt-5">
      <strong>Magdalena Schwarz</strong><br>
      Musterstraße 1<br>
    ...
    <p>
      ...
      E-Mail: office@nahtwerk.at<br>
      Webseite: www.nahtwerk.at
    </p>

    <p class="mt-5"><strong>Umsatzsteuer-ID:</strong></p>
    <p>
      Umsatzsteuerbefreit gemäß § 27 a Umsatzsteuergesetz.<br>
    </p>

    <p class="mt-5"><strong>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</strong></p>
    <p>
    ...
    <h3 class="mt-5 text-lg font-semibold">Haftungsausschluss (Disclaimer)</h3>

    <h4 class="mt-5 text-lg font-semibold">Haftung für Inhalte</h4>
    <p>
    ...
    <h4 class="mt-5 text-lg font-semibold">Haftung für Links</h4>
    <p>
    ...
    <h4 class="mt-5 text-lg font-semibold">Urheberrecht</h4>
    <p>
