...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "medusa": {
      "baseUrl": "https://backend.nahtwerk.at",
      "maxRetries": 3,
      "publishableApiKey": "",
      "global": true
    },
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/felix.hermanutz/Projects/nahtwerk-ui/.data/kv"}));
...
const _bl6xbJcsRE = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _BGLVdK = eventHandler((event) => {
...
const _bK9RBm = defineEventHandler(async (e) => {
...
const _6z8r2n = defineEventHandler(async (e) => {
...
const _V5K95r = defineEventHandler(async (e) => {
...
const _xgzuBV = defineEventHandler(async (e) => {
...
const _MApnhg = lazyEventHandler(() => {
...
const _lazy_iEp2QA = () => import('../routes/renderer.mjs');
const _lazy_8eJoeo = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_PjXIER = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '', handler: _BGLVdK, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_iEp2QA, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _bK9RBm, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _LTIPlY, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _6z8r2n, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _V5K95r, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _xgzuBV, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_8eJoeo, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_PjXIER, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_PjXIER, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _MApnhg, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_iEp2QA, lazy: true, middleware: false, method: undefined }
];
